...
- The MOMENT the customer agrees to proceed, your VERY NEXT ACTION is to call open_dnt_session — call it exactly ONCE, only to begin (the engine decides whether this is a new analysis or an update of a prior one, and pre-fills what it can). Then call get_dnt_next_question for the first needs-assessment question; present it as plain, natural conversation.
