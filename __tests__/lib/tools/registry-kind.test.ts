...
// update_customer_profile retired in B0.1 (the extractedProfile divergence M1 kills)
const COMMITS = ['set_candidate_product', 'switch_product', 'record_gdpr_consent', 'acknowledge_ai_disclosure', 'start_dnt_questionnaire', 'save_dnt_answer', 'sign_dnt', 'start_application', 'save_application_answer', 'set_answer', 'resume_application', 'cancel_application', 'change_selection', 'generate_quote', 'accept_quote', 'modify_quote', 'check_bd_eligibility', 'initiate_payment', 'collect_customer_field', 'escalate_to_human']
...
describe('tool kind classification', () => {
  ...
  it('the 20 committing tools are kind=commit (check_bd_eligibility included — it mutates includesAddon)', () => {
